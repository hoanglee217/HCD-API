...
public class TagGetAllTests(WebApplication<ManagementAppFactory, Program> app) : ManagementTest(app)
{
    ...
    public async Task ShouldGetAllCorrectly()
    {
        ...
        var getAllResponseData = await getAllResponse.Content.ReadFromJsonAsync<TagGetAllResponse>();
